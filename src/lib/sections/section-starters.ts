...
export const SECTION_STARTERS: Record<SectionCategoryId, SectionStarter> = {
  ...
  <div style="${CONTAINER} max-width: 860px; text-align: center;">
    ...
    <h1 style="font-size: 54px; font-weight: 900; line-height: 1.08; letter-spacing: -0.03em; margin: 0 0 18px;"><span style="color: #ffffff;">An</span> <span style="color: #38bdf8;">education</span> <span style="color: #ffffff;">that</span> <span style="color: #38bdf8;">holds</span> <span style="color: #ffffff;">its</span> <span style="color: #38bdf8;">value</span></h1>
    <p style="${LEAD} font-size: 18px;"><span style="color: #cbd5e1;">Nineteen</span> <span style="color: #fbbf24;">departments,</span> <span style="color: #cbd5e1;">a</span> <span style="color: #fbbf24;">residential</span> <span style="color: #cbd5e1;">campus,</span> <span style="color: #fbbf24;">and</span> <span style="color: #cbd5e1;">a</span> <span style="color: #fbbf24;">teaching</span> <span style="color: #cbd5e1;">faculty</span> <span style="color: #fbbf24;">that</span> <span style="color: #cbd5e1;">also</span> <span style="color: #fbbf24;">does</span> <span style="color: #cbd5e1;">the</span> <span style="color: #fbbf24;">research.</span> <span style="color: #cbd5e1;">Applications</span> <span style="color: #fbbf24;">for</span> <span style="color: #cbd5e1;">the</span> <span style="color: #fbbf24;">2027</span> <span style="color: #cbd5e1;">intake</span> <span style="color: #fbbf24;">close</span> <span style="color: #cbd5e1;">on</span> <span style="color: #fbbf24;">15</span> <span style="color: #cbd5e1;">January.</span></p>
